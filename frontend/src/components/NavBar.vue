    ...
    <div class="d-flex align-center">
      ...
      <div class="branding-container">
        ...
        <div class="branding-text-group">
          <h1 class="main-title">YOUTH - (Tenant Name)</h1>
          <p class="sub-title">Youth Officials' Unified Tracking Hub</p>
        </div>
      </div>
    </div>

    <div class="breadcrumb-container">
      <div v-for="(crumb, index) in breadcrumbs" :key="index" class="breadcrumb-wrapper">
        <span 
